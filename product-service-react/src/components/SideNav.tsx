    ...
    return (
        ...
        >
            <Box sx={styles.avatarContainer}>
                <Avatar sx={styles.avatar} alt="Masoud" src="/assets/kh.png" />
                {!collapsed ? <Typography variant="body2" sx={styles.yourChannel}>Wayo Ch</Typography> : null }
            ...
            <Menu
                ...
                <MenuItem 
                    active={activeMenuItem === PRODUCT_TYPE_PATH}
                    component={<Link to={PRODUCT_TYPE_PATH}/>}
                    icon={<SourceOutlinedIcon />}
                    onClick={()=> handleMenuClick(PRODUCT_TYPE_PATH)}> 
